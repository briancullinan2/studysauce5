...
namespace DataLayer.Generators
{
    public class Packs
    {
        public static IEnumerable<Pack> Generate()
        {
            return [
                // Course 1: Foundation
                new Pack { Title = "Level 1: Fundamentals", Description = "Mastering goals, distractions, and study environments.", Tokens = 3, Status = PackStatus.Unpublished },
                new Pack { Title = "Introduction", Description = "Getting started with effective learning habits.", Tokens = 3, Status = PackStatus.Unpublished },
                new Pack { Title = "Setting Goals", Description = "Defining clear, actionable academic objectives.", Tokens = 3, Status = PackStatus.Unpublished },
                ...
                // Course 2: Systems
                new Pack { Title = "Level 2: Systems", Description = "Metrics, planning, and advanced testing strategies.", Price = 3, Status = PackStatus.Unpublished },
                ...
                // Course 3: Mastery
                new Pack { Title = "Level 3: Mastery", Description = "Advanced active learning and memory techniques.", Price = 3, Status = PackStatus.Unpublished },
